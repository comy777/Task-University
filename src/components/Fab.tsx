...
const Fab = ({
	...
	return (
		<View style={fabGroup ? styles.fabGroupContainer : { ...styles.fabContainerBottom, margin: 0 }}>
			{fabGroup && (
				<View style={styles.fabContainerIcons}>
					<View>
						<View style={{ ...styles.fabContainer, height: 50, width: 50, marginBottom: 5 }}>
			...
			<View style={style ? style : styles.fabContainerAround}>
				<View style={styles.fabContainer}>
					{loading ? <Loading /> : <Icon name={icon} color="white" size={42} onPress={onPress} />}
				</View>
			</View>
		</View>
	);
